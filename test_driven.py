...
class TestCalc(unittest.TestCase):
    def test_single_calculation(self):
        self.assertEqual(Single_Calculator.single_calculation(100000),0)# net chargeable income lower than 0
    ...
    def test_joint(self):
        self.assertEqual(Joint_Calculator.joint_calculation(100000,100000),0)# net chargeable income lower than 0
